...
Distortion calibration for EM tracking systems.
Computes expected values for EM tracker readings.
...
if __name__ == "__main__":
    from .data_readers import read_calbody_file, read_calreadings_file
    ...
    try:
        ...
        # Performed distortion calibration
        ...
        # Wrote expected C values to file
