...
Utility functions for writing output files in the required format

This module handles writing output files according to the CIS PA1 specifications:
- NAME-OUTPUT-1.TXT: Contains estimated post positions and expected C values
