...
This module handles reading the various data file formats used in the assignment:
- calbody.txt: Calibration object geometry
- calreadings.txt: Calibration readings from EM tracker
- empivot.txt: EM pivot calibration data
- optpivot.txt: Optical pivot calibration data
...
class CalibrationData:
    """Container for calibration object data."""
